...
createTagBody(1, {->
printHtmlPart(7)
invokeTag('image','asset',23,['src':("grails_logo.png"),'alt':("Grails")],-1)
printHtmlPart(8)
invokeTag('layoutBody','g',25,[:],-1)
printHtmlPart(9)
expressionOut.print(awsMetadata.getPlacement_availability_zone())
printHtmlPart(10)
expressionOut.print(awsMetadata.getLocal_hostname())
printHtmlPart(11)
...
public static final long LAST_MODIFIED = 1462905259000L
