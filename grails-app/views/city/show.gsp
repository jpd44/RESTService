	...
	<body>
		...
		<div id="show-city" class="content scaffold-show" role="main">
			...
			<ol class="property-list city">
				...
				<g:if test="${cityInstance?.testField}">
				<li class="fieldcontain">
					<span id="testField-label" class="property-label"><g:message code="city.testField.label" default="Test Field" /></span>
					
						<span class="property-value" aria-labelledby="testField-label"><g:fieldValue bean="${cityInstance}" field="testField"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${cityInstance?.testField2}">
				<li class="fieldcontain">
					<span id="testField2-label" class="property-label"><g:message code="city.testField2.label" default="Test Field2" /></span>
					
						<span class="property-value" aria-labelledby="testField2-label"><g:fieldValue bean="${cityInstance}" field="testField2"/></span>
